    ...
    <el-main class="main">
      <el-row>
        <el-col :xs="{span: 0, offset: 0}" :sm="{span: 7, offset: 2}" :md="{span: 6, offset: 3}" :lg="{span: 5, offset: 4}" :xl="{span: 4, offset: 5}" class="hidden-xs-only col-main">
          <img src="@/assets/registpage.png" alt="register image">
        </el-col>
          ...
          <div class="formWrapper">
            ...
            >
              ...
              <el-form-item prop="confirmpassword">
                <el-input  v-model="ruleForm.confirmpassword" prefix-icon="el-icon-s-cooperation" type="password" auto-complete="off" placeholder="再次输入密码"></el-input>
              </el-form-item>
              <el-form-item>
